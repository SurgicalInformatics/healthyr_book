...
Figure \@ref(fig:chap7-fig-regression) shows a linear regression example. 
...
knitr::include_graphics("images/chapter07/1_regression_terms.png")
```
...
knitr::include_graphics("images/chapter07/2_residuals.png")
```
...
knitr::include_graphics("images/chapter07/3_diags.png")
```
