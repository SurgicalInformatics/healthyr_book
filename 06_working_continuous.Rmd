...
It is particularity important to ensure that any missing data is identified (see \@ref(chxxx-h1. 
...
```{r, fig.width=7, fig.height=3.5, fig.cap="Histogram: country life expectancy by continent and year"}
mydata %>% 
...
```{r, fig.width=7, fig.height=3.5, fig.cap="Q-Q plot: country life expectancy by continent and year"}
mydata %>% 
  filter(year %in% c(2002, 2007)) %>%
