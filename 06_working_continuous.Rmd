...
# Working with continuous outcome variables{#ch06-h1}
...
It is vital that data is carefully inspected when first read (for help reading data into R see \@ref(ch02-h2-reading-data-into-r)).
The three functions below provide a clear summary allowing errors or miscoding to be quickly identified. 
It is particularity important to ensure that any missing data is identified (see Chapter \@ref(ch13-h1}). 
...
\index{plotting@\textbf{plotting}!geom\_histogram}
\index{plotting@\textbf{plotting}!facet\_grid}
...
```{r, fig.width=7, fig.height=3, fig.cap="Boxplot: country life expectancy by continent and year"}
mydata %>% 
  filter(year %in% c(2002, 2007)) %>%
...
```{r, fig.width=7, fig.height=3, fig.cap="Boxplot with jitter points: country life expectancy by continent and year"}
mydata %>%  
  filter(year %in% c(2002, 2007)) %>%
...
\index{functions@\textbf{functions}!filter}
\index{plotting@\textbf{plotting}!geom\_boxplot}
\index{plotting@\textbf{plotting}!geom\_jitter}
\index{plotting@\textbf{plotting}!facet\_grid}
\index{plotting@\textbf{plotting}!theme}
\index{plotting@\textbf{plotting}!xlab}
\index{plotting@\textbf{plotting}!ylab}
\index{plotting@\textbf{plotting}!ggtitle}
...
```{r fig.height=3, fig.width=3, fig.cap="Line plot: Change in life expectancy in Asian countries from 2002 to 2007"}
...
\index{functions@\textbf{functions}!do}
\index{functions@\textbf{functions}!t.test}
\index{functions@\textbf{functions}!tidy}
...
\index{functions@\textbf{functions}!summary}
...
\index{functions@\textbf{functions}!select}
\index{functions@\textbf{functions}!mutate}
\index{functions@\textbf{functions}!head}
...
```{r fig.height=6, fig.width=6, fig.cap="Panels plots: histogram, Q-Q, boxplot for life expectancy in Africa 1992 v 2007"}
africa_plot = mydata %>%                          
