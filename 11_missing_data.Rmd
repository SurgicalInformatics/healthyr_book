...
### Common solution: rowwise deletion
...
Imputation is not usually appropriate for the explanatory variable of interest or the outcome variable, althought these can be used to impute other variables. 
...
Choose which varible to imput missing values for and which variables to use for the imputation process. 
