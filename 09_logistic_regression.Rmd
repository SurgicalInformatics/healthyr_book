...
knitr::include_graphics("images/chapter09/0_prob_logodds.pdf")
```
...
knitr::include_graphics("images/chapter09/1_odds.pdf")
```
...
knitr::include_graphics("images/chapter09/2_or.pdf")
```
