# RStudio settings, good practice {#install}
...
```{r, eval = FALSE}
healthyr_packages = c("tidyverse", "boot", "finalfit", 
                      "flexdashboard", "gapminder", "here", 
                      "kableExtra", "knitr", "remotes", "rmarkdown", 
                      "shiny", "survminer", "tinytex", "patchwork")
