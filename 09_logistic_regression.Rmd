...
Figure \@ref(fig:chap09-fig-logodds) demonstrates the fitted lines from a logistic regression model of cardiovvascular event by coffee consumption, stratified by smoking on the log-odds scale (A) and the probability scale (B). 
...
If you take a random patient who died and a random patient who did not die, then the c-statistic is the probbaility that the model predicts that patient 1 is more likely to die than patient 2. 
