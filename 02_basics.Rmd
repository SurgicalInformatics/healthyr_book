...
For example, consider a very similar file as above but with some data entry issues introduced:
...
Accidentally using the single equals `=` when double equals is necessary `==` is a very common mistake and still happens to the best of us. 
