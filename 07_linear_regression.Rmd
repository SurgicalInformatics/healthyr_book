...
```{r chap07-fig-equation, echo = FALSE, fig.cap="How a regression line is fitted"}
...
```{r chap07-fig-types, echo = FALSE, fig.cap="How a regression line is fitted"}
knitr::include_graphics("images/chapter07/5_types.pdf")
```
