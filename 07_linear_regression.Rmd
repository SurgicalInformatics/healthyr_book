...
This reference level can be easily changed (REF Ch8 fct_relevel).
...
This is important as frequently people forget that in standard regression models, missing data from any variable results in the that entire row  being excluded from the analysis. 
REF See missing data section. 
