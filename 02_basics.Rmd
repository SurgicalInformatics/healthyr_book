...
This 'removal' excludes the NAs from the calculation, it does not affect the actual tibble (`mydata`) holding the whole dataset. 
...
> If you save the results of an R function in a variable, it does not get printed, and vice versa.
