...
mydata %>% 
  knitr::kable(booktabs = TRUE, caption = "Example of a table, including NA (Not applicable/Not available) values.")
...
In this example, `mydata$var1` is the first and only argument to `mean()`. But what happens if we try to calculate the average value of `var2`?
