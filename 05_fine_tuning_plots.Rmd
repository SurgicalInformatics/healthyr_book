...
```{r chap05-fig-ggsave, echo = FALSE, out.width="100%", fig.cap = "Experimenting with `ggsave()`'s width and height options can be used to quickly change how big or small some of the text on your plot looks like."}
