...
A very unseful function for quickly investigating categorical variables is the `count()` function:
...
For most variables (categorical or numeric) we recommend always plotting your data before starting analys.
