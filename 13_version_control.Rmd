...
```{r chap13-fig-ssh, echo = FALSE, fig.cap="Creating an SSH key in RStudio's Global Options."}
knitr::include_graphics("images/chapter13/1.png", auto_pdf = TRUE)
```

```{r chap13-fig-github, echo = FALSE, fig.cap="Adding your RStudio SSH key to your GitHub account."}
...
```{r chap13-fig-globalsettings, echo = FALSE, fig.cap="Configuring your GitHub account via RStudio, creating a new project, commiting a script and pushing it to GitHub."}
...
```{r chap13-fig-link, echo = FALSE, fig.cap="Linking an RStudio project with a GitHub repository."}
