...
\section{Lets get nerdy}\label{lets-get-nerdy}

R is a programming language. It takes pieces of data, applies
calculations to them, and gives you answers.

Learning a new language is often difficult to start and it's important
to understand why we put ourselves through this ordeal. Can you think of
any advantages of using code rather than clicking on buttons to perform
analyses?
