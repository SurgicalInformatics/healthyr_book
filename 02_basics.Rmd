...
This is quite nice of `mutate()`, but it would be best to give columns names that don't include characters other than letters, numbers, underscores (`_`) or dots (`.`). 
