...
In chapter \@ref(chap13-h1) we emphasised one of the less well known strengths of R  - the ease with which reports can be written in HTML (web page), PDF, or Word documents. 
...
Note that we include missing data in this table (see Chapter \@ref(chap13-h1)).
...
If you have difficulties at this stage, refer to chapter \@ref(chap13-h1).
...
Knitting this into a Word document results in Figure \@ref(fig:chap13-fig-word)A), which looks pretty decent but the some of the columns need some formatting and the plot needs resized.
