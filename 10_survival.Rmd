...
The Cox proportional hazards model is regression model similar to those we have already dealt with. 
...
**A further paragraph of explanation +/- figure akin to chap 7 and chap 9 **
...
For a given predictor then, the hazard in one group (say men) would be expected to be a constant proportion of the hazard in another group (say female). 
...
<!-- Why is this solution commented out? Should we remove the Exercise? -->
