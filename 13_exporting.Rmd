...
This may be as journal article or presentation, or perhaps a regular report or webpage. In chapter \@ref(chap13-h1) we emphasised another of the major strengths of R - the ease with which HTML (a web page), PDF, or Word documents can be generated.
...
The combination of R, RStudio, and Markdown is a powerful triumvirate which produce beautiful results quickly and be greatly labour saving. 
We use this combination for all academic work, but also in the production of real-time reports as webpages and downloadable PDFs for on-going projects. 
